    ...
    <div name="home" className="bg-image w-full h-screen bg-[#0a0a0a]">
      ...
      <div className="bg-text max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <h2 className="text-3xl sm:text-5xl font-bold text-[#8892b0]">
          <strong className="text-4xl sm:text-7xl">Web & Mobile App</strong>{" "}
          Developer.
        </h2>
        <p className="text-[#ccc] py-4 max-w-[700px] no-shadow">
          I’m a junior full-stack developer, with a big interest in the
          application of Machine Learning & Deep Learning algorithms to Mobile
          and Web Apps.
          <Link to="about" smooth={true} duration={500}>
            <button
              className="text-[#0e6067] my-3 flex items-center hover:text-[#2e6067]"
              href="#"
            >
              <em>More about me... </em>{" "}
            </button>
